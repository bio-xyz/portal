import type {
  ...
  EntityPayload,
  MessagePayload,
  ServiceTypeName as CoreServiceTypeName,
  WorldPayload,
} from '@elizaos/core';
import type {
...
export interface IDiscordService {
  ...
  extractServerIdFromMessage(text: string): Promise<string | null>;
}
...
export type ServiceTypeName = CoreServiceTypeName | (typeof ServiceType)[keyof typeof ServiceType];

export const DISCORD_SERVICE_NAME = ServiceType.DISCORD;
